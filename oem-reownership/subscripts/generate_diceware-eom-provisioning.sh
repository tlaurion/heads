...
while [[ ${#oem_usb_security_dongle_Admin_PIN} -lt 8 || ${#oem_usb_security_dongle_Admin_PIN} -gt 20 ]];do
  oem_usb_security_dongle_Admin_PIN=$(diceware -d " " -n 2)
done
echo "oem_usb_security_dongle_Admin_PIN=$oem_usb_security_dongle_Admin_PIN" >> ./oem-provisioning.generated
while [[ ${#oem_usb_security_dongle_User_PIN} -lt 6 || ${#oem_usb_security_dongle_User_PIN} -gt 20 ]];do
  oem_usb_security_dongle_User_PIN=$(diceware -d " " -n 2)
done
...
echo "oem_usb_security_dongle_User_PIN=$oem_usb_security_dongle_User_PIN" >> ./oem-provisioning.generated
...
echo "oem_usb_security_dongle_real_name=$oem_usb_security_dongle_real_name" >> ./oem-provisioning.generated
echo "oem_usb_security_dongle_email=$oem_usb_security_dongle_email" >> ./oem-provisioning.generated
...
echo "oem_usb_security_dongle_comment=$oem_usb_security_dongle_comment" >> ./oem-provisioning.generated
echo "#" >> ./oem-provisioning.generated
echo "########################################" >> ./oem-provisioning.generated
...
echo "oem_TPM_Owner_Password=$oem_usb_security_dongle_Admin_PIN" >> ./oem-provisioning.generated
