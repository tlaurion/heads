...
Universal ADD params are always injected — the ISO's initramfs scripts
(casper, live-boot, dracut) recognize only the parameters they need.
These are built by `_build_universal_add()`:
