...
|----------|--------|--------|------------|----------|
| 1 | vesadrm (DRM) | `vesadrm_probe` | 7.x only (SUSE) | "vesa-framebrowser" via VLFB |
| 2 | vesafb (fbdev) | `vesafb_probe` | 5.x/6.x | "vesa-framebrowser" via VLFB |
| 3 | simpledrm (DRM) | `simpledrm_probe` + `sysfb_parse_mode` | 6.x/7.x | "simple-framebrowser" via SYSFB_SIMPLEFB |
