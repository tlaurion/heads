  ...
  case "$menu_choice" in
    ...
    f|c )
      if (whiptail --title 'Flash the BIOS with a new ROM' \
          --yesno "This requires you insert a USB drive containing:\n* Your BIOS image (*.rom)\n\nAfter you select this file, the program will reflash your BIOS\n\nDo you want to proceed?" 16 90) then
